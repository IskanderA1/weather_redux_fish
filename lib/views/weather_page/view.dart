...
import 'package:weather_redux_fish/util/adapt.dart';
import 'package:weather_redux_fish/widgets/weather_icon.dart';
...
Widget buildView(
  ...
  Widget _buildLocationCell() {
    Widget _child = state.weather?.cityName == null
        ? Container(
        ...
        : Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                Padding(
                  padding:
                      EdgeInsets.only(left: Adapt.px(50), bottom: Adapt.px(15),top: Adapt.px(15)),
                  child: Text(
  ...
  //       children: <Widget>[
  //         InkWell(
  //           onTap: () => dispatch(WeatherActionCreator.isTodaychanged(true)),
  //           child: Text(
  //             'Today',
  ...
  //         InkWell(
  //             onTap: () =>
  //                 dispatch(WeatherActionCreator.isTodaychanged(false)),
  //             child: Text(
  //               'Tomorrow',
